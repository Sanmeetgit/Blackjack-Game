...
def main():
        ...
        arr = []
        arr.append(PIL.ImageTk.PhotoImage(PIL.Image.open("images/uf.png")))
        for i in range(1,53):
            bg = PIL.ImageTk.PhotoImage(PIL.Image.open("images/"+str(i)+".png"))
            arr.append(bg)
        ...
        bg = PIL.ImageTk.PhotoImage(PIL.Image.open("images/casino22.jpg")) #cbg.jpg
        ...
        #unfolded image
        img3 = PIL.ImageTk.PhotoImage(PIL.Image.open("images/uf.png"))


        #Players image
        playr = PIL.ImageTk.PhotoImage(PIL.Image.open("images/dealer111.png"))
        Label(cards2,image=playr,padx=1,pady=1).grid(row=0, column=0)


        #Dealers Image
        deal = PIL.ImageTk.PhotoImage(PIL.Image.open("images/playr12.png"))
        ...
        #Button for new game
        im =  PIL.ImageTk.PhotoImage(PIL.Image.open("images/bothn.jpeg"))
        ...
        #Button for quitting
        Q =  PIL.ImageTk.PhotoImage(PIL.Image.open("images/bothq.jpeg"))
